...
- read uncommitted(0)：读到别人还没提交的数据，别人的数据有可能会被回滚

- **read committed(2)**：oracle, sqlserver默认的隔离级别

- **repeatable read(4)**：mysql默认的级别  A值为100，在这个事务期间，外边无论怎么修改这个A值，读到的都是100

- Serializable(8)：串行化 事务顺序执行 缺乏并行能力
...
![image-20210831233003419](assets/image-20210831233003419.png)
...
动画：http://thesecretlivesofdata.com/raft/ raft算法
